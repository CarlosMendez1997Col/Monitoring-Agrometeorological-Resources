...
var byMonth_Evap = ee.ImageCollection(ee.List.sequence(0, nMonths).map(function (n){
                ...
                return Evap.filterDate(ini,end)
                              .select(0).mean().rename('Monthly VWC 0-7cm')
...
var monthly_evap = ui.Chart.image.series({
  ...
  scale: 5566,
    ...
    title: 'Monthly Average Volumetric Water Content Colombia 0-7cm',
                                 hAxis: {
                                      title: '',
                                      format: 'Y',
                                ...
                                chartArea: {backgroundColor: ''},
                                  trendlines: {0: 
                                    ...
                                    labelInLegend: 'Monthly VWC-L1 Trend'}
                                        },
                })
...
var Annual_Evap = ee.ImageCollection('ECMWF/ERA5_LAND/DAILY_AGGR')
  ...
  var total = seasonFiltered.reduce(ee.Reducer.mean()).rename('Annual VWC 0-7cm');
    return total.set({
...
var annual_evap = ui.Chart.image.series({
  ...
  scale: 5566,
    ...
    title: 'Annual Average Volumetric Water Content Colombia 0-7cm',
                                 hAxis: {
                                      title: '',
                                      format: 'Y',
                                      titleTextStyle: {italic: false, bold: true},
                                ...
                                chartArea: {backgroundColor: ''},
                                  trendlines: {0: 
                                    ...
                                    pointSize: 0,
                                    visibleInLegend: true,
                                    labelInLegend: 'Annual VWC-L1 Trend'}
                                        },
                })
      .setChartType('ColumnChart');
print(annual_evap);
