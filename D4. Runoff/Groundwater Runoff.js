...
var byMonth_Run_S = ee.ImageCollection(ee.List.sequence(0, nMonths).map(function (n){
                ...
                return Run_S.filterDate(ini,end)
                              .select(0).sum().rename('Monthly Run_G')
...
var monthly_Run_S = ui.Chart.image.series({
  ...
  scale: 5566,
    ...
    title: 'Monthly Average Groundwater Runoff Colombia',
                                 hAxis: {
                                      title: '',
                                      format: 'Y',
                                ...
                                chartArea: {backgroundColor: ''},
                                  trendlines: {0: 
                                    ...
                                    labelInLegend: 'Monthly Run_G Trend'}
                                        },
                })
...
var Annual_Run_S = ee.ImageCollection('ECMWF/ERA5_LAND/DAILY_AGGR')
  ...
  var total = seasonFiltered.reduce(ee.Reducer.sum()).rename('Annual Run_G');
    return total.set({
...
var annual_Run_S = ui.Chart.image.series({
  ...
  scale: 5566,
    ...
    title: 'Annual Average Groundwater Runoff in Colombia',
                                 hAxis: {
                                      title: '',
                                      format: 'Y',
                                      titleTextStyle: {italic: false, bold: true},
                                ...
                                chartArea: {backgroundColor: ''},
                                  trendlines: {0: 
                                    ...
                                    pointSize: 0,
                                    visibleInLegend: true,
                                    labelInLegend: 'Annual Run_G Trend'}
                                        },
                })
      .setChartType('ColumnChart');
print(annual_Run_S);
...
// Title
var label_title = 'Groundwater Runoff';
...
// Gradient Bar
var labels = ee.List.sequence(0, 300, 300);
